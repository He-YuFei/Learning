...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button buttonImplClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonImplClickListener = findViewById(R.id.btn_impl_on_click_listener);
        ...
        buttonImplClickListener.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_impl_on_click_listener) {
            Toast.makeText(MainActivity.this, R.string.btn_impl_on_click_listener, Toast.LENGTH_SHORT).show();
        }
    }
}
